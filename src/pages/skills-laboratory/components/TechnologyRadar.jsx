    ...
    <div className="bg-card border border-border rounded-2xl p-8">
      <div className="text-center mb-8">
        ...
        <p className="text-text-secondary">
          Current technology adoption and exploration status
        </p>
      </div>
            ...
            >
              <div className="flex items-center justify-between mb-2">
                ...
                <Icon
                  ...
                  size={16}
                  className={`${
                    activeQuadrant?.trend === "up"
                      ? "text-green-500"
                      : activeQuadrant?.trend === "down"
                      ? "text-red-500"
                      : activeQuadrant?.trend === "new"
                      ? "text-purple-500"
                      : "text-gray-500"
                  }`}
                />
              ...
              <div className="space-y-1 text-sm text-text-secondary">
                <p>
                  ...
                  {rings?.[activeQuadrant?.ring]?.name}
                </p>
                <p>
                  <span className="font-medium">Quadrant:</span>{" "}
                  {quadrants?.[activeQuadrant?.quadrant]?.name}
                </p>
                <p>
            ...
            <div className="space-y-2">
              {Object.entries(rings)?.map(([key, ring]) => (
                <div key={key} className="flex items-center space-x-3">
                  <div
                    className={`w-3 h-3 rounded-full border-2 ${ring?.color?.replace(
                      "text-",
                      "border-"
                    )}`}
                  />
